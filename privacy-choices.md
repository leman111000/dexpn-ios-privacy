...
- Any identifiers you used in communication with support (for example, your Telegram username),
- The approximate date/time of the issue (if relevant).

We may ask follow-up questions to confirm the request and locate the correct records.
...
You control what you share with support. Please avoid sending:
- Passwords,
- Payment card details,
- Sensitive personal data not necessary to solve the issue.
